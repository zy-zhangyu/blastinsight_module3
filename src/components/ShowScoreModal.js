...
import { QuantityModalStep } from './ScoreQuantityModalStep';
...
export const ScoreModal = (props, ref) => {
    ...
    return (
        <Dialog
            ...
            <DialogTitleWithClose onClose={handleClose}>
                <Typography variant="h1">Submit now</Typography>
...
export const scoreModalRef = React.createRef();

export const showScoreModal = (quantity) => {
    if (quantity) {
        scoreModalRef.current?.setQuantity(quantity)
    }
    scoreModalRef.current?.setIsOpen(true);
}
...
export default React.forwardRef(ScoreModal);
